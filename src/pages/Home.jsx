...
const Home =() => {
    ...
    return (
      ...
      <Navbar />
      <Jumbotron title="Manage Property Intelligently" subtitle="Lubn connects you, guests and service providers so you have the freedom to manage property access from anywhere, anytime. "/>
      <div className="container" id="homepage-main" >
